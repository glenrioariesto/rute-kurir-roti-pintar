...
export function PortraitWarning() {
  return (
    <div className="hidden portrait:flex fixed inset-0 z-[9999] bg-slate-950 text-slate-100 flex-col items-center justify-center text-center p-6 select-none animate-fade-in">
