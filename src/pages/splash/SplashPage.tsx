...
export function SplashPage({ onStart, isSoundOn, onToggleSound, onPlayClick }: SplashPageProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-4 left-4 sm:top-6 sm:left-6 2xl:top-10 2xl:left-10 z-30">
        <img 
          src={logoPusbuk} 
          alt="Logo Pusbuk" 
      ...
      <div className="absolute top-4 right-4 sm:top-6 sm:right-6 2xl:top-10 2xl:right-10 z-30">
        <button
