    ...
    <>
      ...
      {showFullscreenPrompt && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-slate-900/60 backdrop-blur-md p-4 select-none animate-fadeIn">
          <div className="relative max-w-sm w-full mx-auto bg-white border-[3px] border-[#0f5a31] shadow-2xl rounded-3xl p-6 sm:p-8 flex flex-col items-center text-center">
            ...
            <h3 className="text-lg sm:text-xl font-black text-slate-800 tracking-tight mb-2 uppercase font-display">
              Mode Layar Penuh
            </h3>
