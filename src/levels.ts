...
export const levels: LevelConfig[] = [
  {
    ...
    houses: [
      { id: 'Toko', name: 'Toko Roti🥖', x: 95, y: 375, markerImage: `${import.meta.env.BASE_URL}point-roti.webp`, markerSize: 40, hideIcon: true, markerOffset : { x: -45, y: -95, },radarColor: "#E0A060", radarOffset: { x: 0, y: 15 } },
      { id: 'A', name: 'Rumah A', x: 195, y: 325, markerImage: `${import.meta.env.BASE_URL}point-a.webp`, markerSize: 40, markerOffset : { x: -20, y: -85  , }, radarColor: "#F2000D", radarOffset: { x: 0, y: 15 } },
      { id: 'B', name: 'Rumah B', x: 365, y: 225, markerImage: `${import.meta.env.BASE_URL}point-b.webp`, markerSize: 40, hideIcon: true, markerOffset : { x:-40, y: -70, }, radarColor: "#FC8C00", radarOffset: { x: 0, y: 15 } },
      { id: 'C', name: 'Rumah C', x: 325, y: 325, markerImage: `${import.meta.env.BASE_URL}point-c.webp`, markerSize: 40, hideIcon: true, markerOffset : { x: 35, y: -65, }, radarColor: "#B25826", radarOffset: { x: 0, y: 15 } },
      { id: 'D', name: 'Rumah D', x: 560, y: 375, markerImage: `${import.meta.env.BASE_URL}point-d.webp`, markerSize: 40, hideIcon: true, markerOffset : { x: -10, y: -85, }, radarColor: "#FEBE00", radarOffset: { x: 0, y: 15 } },
      { id: 'E', name: 'Rumah E', x: 500, y: 230, markerImage: `${import.meta.env.BASE_URL}point-e.webp`, markerSize: 40, hideIcon: true, markerOffset : { x: 40, y: -70, }, radarColor: "#009B00", radarOffset: { x: 0, y: 15 } },
      { id: 'F', name: 'Rumah F', x: 670, y: 200, markerImage: `${import.meta.env.BASE_URL}point-f.webp`, markerSize: 40, hideIcon: true, markerOffset : { x: 35, y: -85, }, radarColor: "#009791", radarOffset: { x: 0, y: 15 } },
